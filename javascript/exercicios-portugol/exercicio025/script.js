...
if (reta1 < reta2+reta3 && reta2 < reta1+reta3 && reta3 < reta1+reta2) {
    txt.innerHTML = (`Com estes tamanhos: <br> Reta 1:  ${reta1} <br> Reta 2:  ${reta2} <br> Reta 3:  ${reta3} <br> É possível formar um triângulo!`);
} else {
    txt.innerHTML = (`Com estes tamanhos: <br> Reta 1:  ${reta1} <br> Reta 2:  ${reta2} <br> Reta 3:  ${reta3} <br> Não é possível f triângulo`); 
};